      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-4">
        ...
        <div className="w-full tracking-wide space-y-4">
          ...
          <form action="" method='post' onSubmit={handelsubmit} className="max-w-md mx-auto space-y-4">
            ...
            <button type="submit" className="w-full py-1.5 text-white font-medium dark:text-black dark:hover:text-white bg-black dark:bg-white hover:bg-zinc-700 dark:hover:bg-zinc-700 flex flex-row items-center justify-center rounded-md group">
              {!loading ? <span>Submit</span> : <div className="w-6 h-6 border border-t-2 border-t-white dark:border-t-gray-700 border-transparent group-hover:border-t-white rounded-full animate-spin duration-200"></div>}
            </button>
