        ...
        <footer className="w-full px-4 lg:px-0">
            <div className="max-w-6xl mx-auto border-t border-gray-600">
                <div className="py-4 flex flex-col-reverse md:flex-row items-center justify-between gap-6">
                    <p className="text-sm ">&copy; 2025 Muskaan. All Rights Reserved.</p>
                    <div className="flex items-center gap-4">
                        ...
                        <a href="https://instagram.com/muskaan_chhikara" className="" target='_blank' rel="noreferrer"><RiInstagramFill className="w-5 h-5 hover:text-gray-400 transition-all duration-200" /></a>
                        ...
                        <a href="https://www.linkedin.com/in/" className="" target='_blank' rel="noreferrer"><RiLinkedinBoxFill className="w-5 h-5 hover:text-gray-400 transition-all duration-200" /></a>
