          ...
          <a href="" className="hover:-translate-y-2 hover:shadow-xl border border-gray-100 dark:border-gray-900 rounded-lg transition-all duration-200">
            <div className="rounded-lg">
              ...
              <div className="px-4 py-2.5">
                <h2 className="text-lg font-semibold">Ecommerce website</h2>
                <p className="text-base text-gray-900 dark:text-gray-400 font-medium">Responsive Ecommerce website.</p>
              </div>
            </div>
          </a>
          <a href="" className="hover:-translate-y-2 hover:shadow-xl border border-gray-100 dark:border-gray-900 rounded-lg transition-all duration-200">
            <div className="rounded-lg">
              ...
              <div className="px-4 py-2">
                ...
                <p className="text-base text-gray-900 dark:text-gray-400 font-medium">App UI/UX Design with Figma</p>
              </div>
            </div>
          </a>
          <a href="" className="hover:-translate-y-2 hover:shadow-xl border border-gray-100 dark:border-gray-900 rounded-lg transition-all duration-200">
            <div className="rounded-lg">
              ...
              <div className="px-4 py-2">
                ...
                <p className="text-base text-gray-900 dark:text-gray-400 font-medium">Dashboard Full stack web dev.</p>
              </div>
            </div>
          </a>
        </div>
